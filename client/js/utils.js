...
`
    ...
    // (2) el nomnbre del paquete donde se encuentra la rpc ejecutar y
...
/*
    LoadAvailableProtosAsDropdownOptions: Calls a REST API to get which are the available protofiles to allow the user to select one to load.
 */
...
/*
 GetExistingProtofilesInServer: calls REST API to get all existing protofiles.
 */
