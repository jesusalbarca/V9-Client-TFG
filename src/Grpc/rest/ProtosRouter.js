...
router.get('/protos',
    async function (req, res) {
        ...
        const files = await fs.promises.readdir("C:\\Users\\cored\\Desktop\\Github\\ixci-grpc\\proto");
...
router.get('/def/packages/:protofile', async function (req, res) {
    ...
    console.log("\t\trequest to /def/packages (returns .proto file components in structured form)".red())
